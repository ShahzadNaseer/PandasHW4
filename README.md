...
We are given with following two data files:

1. schools_complete.csv
2. students_complete.csv

We are asked to analyze the district-wide standardized test results. My responsibility is to aggregate the data to and showcase obvious trends in school performance.
